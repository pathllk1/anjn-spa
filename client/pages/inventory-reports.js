            ...
            <tr>
              ...
              <th class="px-3 py-2.5 text-right text-xs font-semibold text-white uppercase tracking-wider cursor-pointer hover:bg-white/10 transition hidden md:table-cell" data-sort="gtot" data-col="gtot">
                <div class="flex items-center justify-end gap-1">
                  ...
                  <div class="flex items-center gap-1">Taxable<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-3 h-3 sort-icon opacity-40"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 15L12 18.75 15.75 15M8.25 9l3.75-3.75L15.75 9" /></svg></div>
                </div>
              </th>
              <th class="px-3 py-2.5 text-right text-xs font-semibold text-white uppercase tracking-wider cursor-pointer hover:bg-white/10 transition hidden md:table-cell" data-sort="tax" data-col="tax">
                <div class="flex items-center justify-end gap-1">
                  ...
                  <div class="flex items-center gap-1">Tax<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-3 h-3 sort-icon opacity-40"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 15L12 18.75 15.75 15M8.25 9l3.75-3.75L15.75 9" /></svg></div>
                </div>
              </th>
