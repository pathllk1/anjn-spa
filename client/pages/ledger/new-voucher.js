    ...
    <div class="max-w-4xl mx-auto px-4 py-12 space-y-8">
      <div class="flex justify-between items-center">
        ...
        <div class="flex gap-3">
          <a href="/ledger/bank-accounts" data-navigo class="px-5 py-3 rounded-lg border border-gray-200 bg-white text-gray-700 font-medium hover:bg-gray-50 transition">
